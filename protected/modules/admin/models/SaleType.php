...
/**
 * This is the model class for table "tbl_sale_type".
 *
 * The followings are the available columns in table 'tbl_sale_type':
...
class SaleType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('sale_type_id, title, isactive, environments, created, updated', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'bookings' => array(self::HAS_MANY, 'Booking', 'sale_type_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('sale_type_id',$this->sale_type_id);
