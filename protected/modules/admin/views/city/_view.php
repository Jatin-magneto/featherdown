...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('city_slug')); ?>:</b>
	<?php echo CHtml::encode($data->city_slug); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('city_abbreviation')); ?>:</b>
	<?php echo CHtml::encode($data->city_abbreviation); ?>
	<br />
