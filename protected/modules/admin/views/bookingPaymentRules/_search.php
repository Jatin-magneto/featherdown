...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'payment_rule_id'); ?>
		<?php echo $form->textField($model,'payment_rule_id'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'request_send_before'); ?>
		<?php echo $form->textField($model,'request_send_before'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'payment_before_days'); ?>
		<?php echo $form->textField($model,'payment_before_days'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'payment_term'); ?>
