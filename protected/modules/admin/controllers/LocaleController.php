...
class LocaleController extends Controller
{
	...
	public function actionDeleterec()
	{
		try{
			...
			Locale::model()->deleteAll("locale_id IN ($id)");
			$this->redirect(array('admin'));
	...
	{
		$dataProvider=new CActiveDataProvider('Locale');
	...
	{
		$model=new Locale('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Locale']))
			$model->attributes=$_GET['Locale'];
	...
	{
		$model=Locale::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Locale $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='locale-form')
		{
