...
class EnvironmentController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Environment'];
            $user = Yii::app()->user;
	...
	{
		$dataProvider=new CActiveDataProvider('Environment');
	...
	{
		$model=new Environment('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Environment']))
			$model->attributes=$_GET['Environment'];
	...
	{
		$model=Environment::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Environment $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='environment-form')
		{
