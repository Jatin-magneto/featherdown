...
class LedgerCategoryController extends Controller
{
	...
	{
		$model=new LedgerCategory;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['LedgerCategory']))
		{
			$model->attributes=$_POST['LedgerCategory'];
	...
	*/
	public function actionDeleterec()
	{
		try{
			...
			LedgerCategory::model()->deleteAll("ledger_id IN ($id)");
	...
	{
		$dataProvider=new CActiveDataProvider('LedgerCategory');
	...
	{
		$model=new LedgerCategory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['LedgerCategory']))
			$model->attributes=$_GET['LedgerCategory'];
	 ...
	 * @return LedgerCategory the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=LedgerCategory::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param LedgerCategory $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ledger-category-form')
		{
