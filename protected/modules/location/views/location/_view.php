...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('supplier_form_url')); ?>:</b>
	<?php echo CHtml::encode($data->supplier_form_url); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('tax_included')); ?>:</b>
	<?php echo CHtml::encode($data->tax_included); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('latitute')); ?>:</b>
	<?php echo CHtml::encode($data->latitute); ?>
	<br />
