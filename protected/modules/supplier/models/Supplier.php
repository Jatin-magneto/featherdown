...
class Supplier extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('email', 'email'),
			array('dob, remarks', 'safe'),
			array('password, repeat_password', 'safe', 'on' => 'update'),
			array('repeat_password', 'compare', 'compareAttribute'=>'password', 'on' => 'insert'),
			array('repeat_password', 'compare', 'compareAttribute'=>'password', 'on' => 'forgotpwd'),
			array('username', 'unique', 'className' => 'Supplier', 'attributeName' => 'username', 'message'=>'This user name is already taken'),
			array('email', 'unique', 'className' => 'Supplier', 'attributeName' => 'email', 'message'=>'This e-mail is already in use'),
